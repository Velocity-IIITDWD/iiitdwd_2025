...
const JumpLink = (props: jumpLinksProps) => {
  return (
    <li>
      <Link
        className="px-4 rounded uppercase text-sm font-medium py-2 bg-white text-primary"
...
export default function HeroSection() {
  return (
    <div className="z-[2] container px-4 text-center md:px-8 mx-auto h-full items-center justify-center flex flex-col gap-3 text-white">
      ...
      <div className="font-semibold leading-[1.1] text-[clamp(2rem,10vw,4rem)] max-w-5xl text-center">
        See Where One Small Step Can Take You
      </div>
      <div className="text-lg md:text-xl max-w-4xl text-slate-200">
