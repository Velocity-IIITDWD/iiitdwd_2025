...
export default function SortSearch({
  ...
  return (
    <div className="bg-secondary/50 flex sm:items-center rounded-md text-sm text-main w-full sm:w-auto self-end sm:self-auto flex-col sm:flex-row gap-2 sm:gap-0 md:mb-auto">
