    ...
    <div className="grid grid-cols-2 gap-1 h-full p-1">
      {socialMedia.map((platform) => (
        <Link
          ...
          className="group"
        >
          <div className="bg-white rounded-lg p-4 flex flex-col items-center justify-center h-full transition-all duration-300 shadow-sm hover:shadow-md hover:translate-y-[-2px]">
            {platform.icon}
