export const footerLinks = [
  ...
  },
  {
    title: 'INFORMATION',
    links: [
      { text: 'About Institute', href: '/institute/about' },
      { text: 'Admissions', href: '/admissions/procedure' },
      ...
      { text: 'Campus', href: '/institute/campus/' }
    ]
  },
  {
    title: 'CONNECT',
    links: [
      ...
      { text: 'Virtual Tour', href: '/institute/gallery' },
