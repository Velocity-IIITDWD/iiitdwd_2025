...
export default function TwitterSide() {
  ...
  return (
    <div
      className={`fixed right-0 flex top-1/2 -translate-y-1/2 z-[100] transition duration-300 ${
        isOpen ? '-translate-x-0' : 'translate-x-full'
      }`}
    >
      <div
        onClick={toggleBox}
        className="absolute left-0 top-1/2 -translate-y-full -translate-x-full -rotate-90 origin-bottom-right"
      >
